...
void Player::Draw(Game &window, double round_time) {
  ...
  health_sprite.setTexture(health_textures_[health_points_%4]);
  health_sprite.scale(0.03, 0.03);
  health_sprite.move(sf::Vector2f(0.f, 0.f));
  health_sprite.setPosition(sf::Vector2f(0.f, 0.f));
